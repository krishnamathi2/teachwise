...
async function handler(req, res) {
    ...
    try {
        ...
        const backendUrl = process.env.BACKEND_URL || process.env.NEXT_PUBLIC_BACKEND || process.env.NEXT_PUBLIC_BACKEND_URL || "https://teachwise-8lpxy8ra-krishnamathi2s-projects.vercel.app";
        ...
        if (error.name === "AbortError") {
            ...
            return res.status(500).json({
                ...
                errorMessage:  false ? 0 : undefined
            });
        }
    }
}
...
var __webpack_exports__ = (__webpack_exec__(6693));
